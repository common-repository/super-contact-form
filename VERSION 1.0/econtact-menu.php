...
This file is part of SUPER CONTACT FORM.

SUPER CONTACT FORM is free software: you can redistribute it and/or
modify it under the terms of the GNU General Public License as
published by the Free Software Foundation, either version 3 of
the License, or (at your option) any later version.

SUPER CONTACT FORM is distributed in the hope that it will be useful,
but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
GNU General Public License for details.

You should have received a copy of the GNU General Public License
along with SUPER CONTACT FORM. If not, see www.gnu.org/licenses/.
*/
...
?>
<div class="wrap">
	<h2><?php _e( 'Super Contact Form', 'easy_contact' ) ?></h2>
	<p><?php _e( 'Thank you for using this <a href="http://www.detoxdietabc.com/" title="Detox Diet">Detox Diet</a> plugin. When deactivating this plugin, its settings will be permanently deleted from you database.', 'exop' ) ?></p>
